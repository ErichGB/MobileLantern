...
- Consulta la [guía de uso básico]({{< ref "uso-basico" >}})
- Revisa la sección [qué es MobileLantern]({{< ref "que-es" >}})
- Contacta con tu profesor o coordinador técnico
...
Actualmente MobileLantern solo está disponible para Android. No hay planes inmediatos para una versión iOS, pero dependerá de la demanda y recursos del proyecto.

### ¿La aplicación es gratuita?

Sí, MobileLantern es un proyecto de investigación educativa y es gratuito para instituciones y estudiantes que participan en el programa.

---

¿No encontraste respuesta a tu pregunta? Consulta con tu profesor o el soporte técnico de tu institución.
